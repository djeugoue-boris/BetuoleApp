...
<style>
  ...
  /* Style violent pour la table admins */
  .dataTable {
...
<nav class="sidebar" role="navigation" aria-label="Menu principal">
  ...
  <a href="#"><i class="fa-solid fa-user-shield"></i><span> Gérer Admins</span></a>
  <a href="apprenants.php"><i class="fa-solid fa-user-graduate"></i><span> Gérer Apprenants</span></a>
...
if (isset($_GET['delete_id'])) {
  ...
  if ($stmtCheck->fetchColumn() > 0) {
    ...
    $stmtPaiement = $pdo->prepare("SELECT COUNT(*) FROM paiements WHERE id_utilisateur = ?");
    $stmtPaiement->execute([$delete_id]);

    if ($stmtPaiement->fetchColumn() > 0) {
      echo "<br><br><br><center><p style='color:red; font-weight:bold;'>Impossible de supprimer cet administrateur car des paiements y sont liés.</p></center>";
      echo "<br><br><br><br><br><br><center><a href='admins.php' style='color:blue;'>Retour</a>";
      exit;
    }
    ...
    echo("<br><br><br><center>Bravo, suppression réussie ! <a href='admins.php' style='color:green; font-weight: bold;'>Continuer maintenant</a>");
    exit;
  } else {
    echo "<br><br><br><center><p style='color:red;'>Admin introuvable ou suppression non autorisée.</p>";
    echo "<br><br><br><center><a href='admins.php'>Retour</a>";
  }
}
...
<div class="container-fluid">
  <h4 class="mb-4">👑 Liste des administrateurs</h4>
  ...
  <table id="adminsTable" class="table table-bordered table-hover table-striped table-responsive nowrap align-middle" style="width:100%">
        ...
        <tr>
          ...
          <td>
            <button class="btn btn-sm btn-warning edit-btn"
              ...
              data-matricule="<?= $admin['matricule'] ?>"
            >
              <i class="fas fa-edit"></i>
            </button>
            <a href="admins.php?delete_id=<?= $admin['id'] ?>" onclick="return confirm('Supprimer cet admin ?')" class="btn btn-sm btn-danger">
...
<div class="modal fade text-dark" id="addUserModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="add_utilisateur.php" class="modal-content">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <form method="post" action="edit_utilisateur.php" class="modal-content">
